package com.goldcrafterxd.techadvanced.fluid;
...
public class ModFluids {
    ...
    public static final ForgeFlowingFluid.Properties OIL_PROPERTIES = new ForgeFlowingFluid.Properties(
            ...
            .density(15).luminosity(2).viscosity(5).sound(SoundEvents.BOTTLE_FILL).overlay(WATER_OVERLAY_RL)
            .color(0x0F0F0F0F)).slopeFindDistance(2).levelDecreasePerBlock(2)
